...
//   }
  ...
  static Future saveType({required String type}) async {
    await _storage.write(key: "type", value: type);
  }

  static Future<String?> readType() async {
    String? value = await _storage.read(key: "type");
    return value;
  }

  static Future saveData({required String data}) async {
    await _storage.write(key: "data", value: data.toString());
  }
